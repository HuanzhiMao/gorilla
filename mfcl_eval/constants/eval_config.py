...
# installation. You can override this by setting the ``MFCL_PROJECT_ROOT``
# environment variable.
PROJECT_ROOT = Path(os.getenv("MFCL_PROJECT_ROOT", Path(__file__).resolve().parents[2]))
...
FORMAT_SENSITIVITY_IDS_PATH = PROMPT_PATH / "MFCL_v4_format_sensitivity.json"
