...
from mfcl_eval.model_handler.api_inference.gemma import GemmaAPIHandler
from mfcl_eval.model_handler.api_inference.glm import GLMAPIHandler
...
from mfcl_eval.model_handler.local_inference.qwen25_fc import Qwen25FCHandler
...
api_inference_model_map = {
    ...
    "mistral-medium-2508": ModelConfig(
        ...
        display_name="Mistral-Medium-2508 (Prompt)",
        url="https://docs.mistral.ai/guides/model-selection/",
        org="Mistral AI",
        license="Proprietary",
        model_handler=MistralHandler,
    ...
    "mistral-medium-2508-FC": ModelConfig(
        model_name="mistral-medium-2508-FC",
    ...
    "gemini-2.5-flash-lite-FC": ModelConfig(
        model_name="gemini-2.5-flash-lite-FC",
...
vision_model_map = {
    ...
    "qwen2.5-vl-72b-instruct": ModelConfig(
        ...
        display_name="Qwen2.5-VL-72B-Instruct (Prompt)",
    ...
    "qwen2.5-vl-32b-instruct": ModelConfig(
        model_name="Qwen/Qwen2.5-VL-32B-Instruct",
        display_name="Qwen2.5-VL-32B-Instruct (Prompt)",
    ...
    "qwen2.5-vl-7b-instruct": ModelConfig(
        model_name="Qwen/Qwen2.5-VL-7B-Instruct",
        display_name="Qwen2.5-VL-7B-Instruct (Prompt)",
    ...
    "qwen2.5-vl-3b-instruct": ModelConfig(
        ...
        display_name="Qwen2.5-VL-3B-Instruct (Prompt)",
    ...
    "qwen2.5-vl-2b-instruct": ModelConfig(
        model_name="Qwen/Qwen2.5-VL-2B-Instruct",
        display_name="Qwen2.5-VL-2B-Instruct (Prompt)",
        url="https://huggingface.co/Qwen/Qwen2.5-VL-2B-Instruct",
        org="Qwen",
        license="apache-2.0",
        model_handler=QwenAPIHandler,
        input_price=None,
    ...
    "magistral-medium-2509": ModelConfig(
        ...
        display_name="Magistral-Medium-2509 (Prompt)",
        url="https://huggingface.co/magistral-ai/Magistral-Medium-2509",
        org="Magistral",
        license="apache-2.0",
        model_handler=MistralHandler,
        input_price=None,
    ...
    "pixtral-large-2411": ModelConfig(
        model_name="pixtral-large-2411",
        display_name="Pixtral-Large-2411 (Prompt)",
        url="https://huggingface.co/pixtral-ai/Pixtral-Large-2411",
        org="Magistral",
        license="apache-2.0",
        model_handler=MistralHandler,
        input_price=None,
