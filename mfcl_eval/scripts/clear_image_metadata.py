"""
clear EXIF metadata from images in mfcl_eval/data/images
"""
...
def main():
    ...
    images_dir = script_dir / "mfcl_eval" / "data" / "images"
    
    # If script is run from a different location, try relative to berkeley-function-call-leaderboard
    if not images_dir.exists():
        images_dir = Path("berkeley-function-call-leaderboard/mfcl_eval/data/images")
    
    if not images_dir.exists():
        images_dir = Path("mfcl_eval/data/images")
